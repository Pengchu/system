;(function () {
    ...
    // 登录表单提交 
    var ajaxForm_login = $('form.js-ajax-login-form');
    if (ajaxForm_login.length) {
        Wind.use('ajaxForm', 'validate', function () {
            var $btn;
            $('button.js-ajax-login-submit').on('click', function (e) {
                var btn = $(this), form = btn.parents('form.js-ajax-login-form');
                $btn    = btn;
                if (btn.data("loading")) {
                    return;
                }
                        ...
                        $form.ajaxSubmit({
                            ...
                            success: function (data, statusText, xhr, $form) {
                                ...
                                if (data.code == 1) {
                                    ...
                                    $('.do-login-msg').removeClass('sr-only').find('span').text(data.msg);
                                    $btn.removeProp('disabled').removeClass('disabled');
                                    $(window).focus();
                                }
                            ...
                            error: function (xhr, e, statusText) {
                                $('.do-login-msg').removeClass('sr-only').find('span').text(statusText);
                            },
                            complete: function () {
                                $btn.data("loading", false);
                            }
